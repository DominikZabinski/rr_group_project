...
paste("Kruskal-Wallis, p =", p_value)
```
...
group_C <- BDG[BDG$treatment_group == "C", "kept"]
group_TD <- BDG[BDG$treatment_group == "TD", "kept"]
group_MD <- BDG[BDG$treatment_group == "MD", "kept"]
...
group_C <- df[df$treatment_group == "C", "attention"]
group_TD <- df[df$treatment_group == "TD", "attention"]
group_MD <- df[df$treatment_group == "MD", "attention"]
